...
import 'n4common_model.dart';
import 'package:excel/excel.dart';

final N4CommonPageProvider =
    StateNotifierProvider<N4CommonPageController, N4CommonPageModel>((ref) {
  return N4CommonPageController(widgetRef: ref);
});

class N4CommonPageController extends StateNotifier<N4CommonPageModel> {
  N4CommonPageController({required this.widgetRef})
      : super(const N4CommonPageModel());

  final StateNotifierProviderRef widgetRef;
  late SharedPreferences preferences;
  bool? get isShowPreference => preferences.getBool("isShowSpeechIcon");
  @override
  N4CommonPageModel get state;
  void setModelListenable(WidgetRef ref) {
    ref.watch(N4CommonPageProvider);
