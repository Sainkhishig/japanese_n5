...
part of 'xl_kanji_hive_model.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class XlKanjiHiveModelAdapter extends TypeAdapter<XlKanjiHiveModel> {
  @override
  final int typeId = 3;

  @override
  XlKanjiHiveModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return XlKanjiHiveModel()
      ..level = fields[0] as int
      ..kanji = fields[1] as String
      ..onReading = fields[2] as String
      ..kunReading = fields[3] as String
  ...
  @override
  void write(BinaryWriter writer, XlKanjiHiveModel obj) {
    writer
      ..writeByte(21)
      ..writeByte(0)
      ..write(obj.level)
  ...
  bool operator ==(Object other) =>
      ...
      other is XlKanjiHiveModelAdapter &&
