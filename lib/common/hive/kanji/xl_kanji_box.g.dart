...
part of 'xl_kanji_box.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class XlKanjiBoxAdapter extends TypeAdapter<XlKanjiBox> {
  @override
  final int typeId = 2;

  @override
  XlKanjiBox read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, XlKanjiBox obj) {
    writer
      ..writeByte(15)
      ..writeByte(0)
      ..write(obj.level)
