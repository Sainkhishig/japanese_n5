...
import 'elementary_frame_page_model.dart';
import 'package:flutter/services.dart';

final elementaryFramePageProvider = StateNotifierProvider<
    ElementaryFramePageController, ElementaryFramePageModel>((ref) {
  return ElementaryFramePageController(ref: ref);
});

class ElementaryFramePageController
    extends StateNotifier<ElementaryFramePageModel> {
  ElementaryFramePageController({required this.ref})
      : super(const ElementaryFramePageModel());
  final StateNotifierProviderRef ref;
  late SharedPreferences preferences;
  bool? get isShowPreference => preferences.getBool("isShowSpeechIcon");
  void setModelListenable(WidgetRef ref) {
    ref.watch(elementaryFramePageProvider);
