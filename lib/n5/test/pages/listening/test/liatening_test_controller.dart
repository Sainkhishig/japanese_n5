...
final listeningTestController =
    StateNotifierProvider<ListeningTestController, ListeningTestState>(
        (ref) => ListeningTestController(ref: ref));
final _database = FirebaseDatabase.instance.reference();

class ListeningTestController extends StateNotifier<ListeningTestState> {
  ...
  //#region ==================== constructor ====================
  ListeningTestController({required this.ref})
      : super(const ListeningTestState());
  //#endregion ==================== constructor ====================

  //#region ==================== accessor ====================
  ListeningTestState? get facility => state;

  //#endregion ==================== accessor ====================

  //#region ==================== method ====================
  clearState() => state = const ListeningTestState();

  Future<ListeningTestState?> getCancellationPolicyDetail(
  ...
  //#endregion ---------- facility ----------
  //#region ---------- save ----------
  Future<bool> save(ListeningTestModel detail) async {
    try {
      String query = r'''
  ...
  void write(ListeningTestModel detail) {
    // var _todoQuery = _database.child("/category");
