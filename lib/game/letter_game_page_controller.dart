import 'dart:convert';
import 'package:afen_vocabulary/jp_constant/letter/letter_model.dart';
...
final letterGameProvider =
    StateNotifierProvider<LetterGamePageController, LetterModel>((ref) {
  return LetterGamePageController(widgetRef: ref);
});

class LetterGamePageController extends StateNotifier<LetterModel> {
