...
import 'import_vocabulary_model.dart';

final vocabularyCardProvider = StateNotifierProvider<
    ImportVocabularyPageController, ImportVocabularyModel>((ref) {
  return ImportVocabularyPageController(widgetRef: ref);
});

class ImportVocabularyPageController
    extends StateNotifier<ImportVocabularyModel> {
  ImportVocabularyPageController({required this.widgetRef})
      : super(const ImportVocabularyModel());
  final _database = FirebaseDatabase.instance.reference();
  final StateNotifierProviderRef widgetRef;
  @override
  ImportVocabularyModel get state;
