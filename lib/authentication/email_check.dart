  ...
  Widget build(BuildContext context) {
    ...
    if (_btn_click_num == 0) {
      if (widget.from == 1) {
        ...
        _nocheckText =
            'Бүртгэл хараахан дуусаагүй байна.\nБаталгаажуулах шуудангийн холбоосыг дарж бүртгэлээ баталгаажуулна уу.';
        _sentEmailText = '';
      }
    }
                ...
                onPressed: () async {
                  ...
                  if (_result!.user!.emailVerified) {
                    ...
                    setState(() {
                      _btn_click_num++;
                      _nocheckText =
                          "Бүртгэл хараахан дуусаагүй байна.\nБаталгаажуулах шуудангаар илгээсэн холбоосыг дарж бүртгэлээ баталгаажуулна уу.";
                    });
                  }
                },
