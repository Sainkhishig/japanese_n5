...
import 'particle_card_page_controller.dart';

class ParticleCardPage extends HookConsumerWidget {
  ParticleCardPage({Key? key}) : super(key: key);
  late List<JLPTLevel> listLevel = [];
  late List<String> listInterval = [];
  late N5Box lstN5;
  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final controller = ref.watch(particleCardProvider.notifier);
    ...
    var lstVocabul = lstN5db.box.get("N5Particle");
