...
import 'pronoun_card_page_controller.dart';

class PronounCardPage extends HookConsumerWidget {
  PronounCardPage({Key? key}) : super(key: key);
  late N5Box lstN5;
                    ...
                    itemBuilder: (BuildContext ctx, index) {
                      return Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                                "${currentLetter.lstLetter[index].reading} - ${currentLetter.lstLetter[index].meaning}"),
                            Visibility(
                              visible: currentLetter
                                  .lstLetter[index].kanji.isNotEmpty,
                              child: Text(
                                  "(${currentLetter.lstLetter[index].kanji})"),
                            )
                          ],
                        ),
                      );
