...
final studentCommentPageController =
    StateNotifierProvider<StudentCommentPageController, KanjiTestState>(
        (ref) => StudentCommentPageController(ref: ref));
final _database = FirebaseDatabase.instance.reference();

class StudentCommentPageController extends StateNotifier<KanjiTestState> {
  ...
  //#region ==================== constructor ====================
  StudentCommentPageController({required this.ref})
      : super(const KanjiTestState());
