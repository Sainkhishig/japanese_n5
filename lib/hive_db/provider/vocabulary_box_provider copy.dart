...
final xlVocabularyBoxDataProvider =
    Provider<XlVocabularyBox>((ref) => throw UnimplementedError());

class XlVocabularyBox extends HiveBoxClass {
  XlVocabularyBox(Box box) : super(box) {}
